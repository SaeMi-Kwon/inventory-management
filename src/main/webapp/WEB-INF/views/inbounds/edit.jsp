...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/inbounds/detail/${inbound.inboundId}" class="btn btn-secondary">
            상세
        </a>
    </div>
    ...
    <form action="/inbounds/edit/${inbound.inboundId}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" value="${inbound.inboundNo}" readonly>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label">입고유형</label>
                        <select name="inboundType" class="form-select" required>
                            <option value="PURCHASE" ${inbound.inboundType == 'PURCHASE' ? 'selected' : ''}>구매입고</option>
                            <option value="PRODUCTION" ${inbound.inboundType == 'PRODUCTION' ? 'selected' : ''}>생산입고</option>
                            <option value="INITIAL" ${inbound.inboundType == 'INITIAL' ? 'selected' : ''}>초기재고</option>
                            <option value="ADJUST" ${inbound.inboundType == 'ADJUST' ? 'selected' : ''}>조정입고</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="customerId" class="form-select">
                            ...
                            <c:forEach var="customer" items="${customerList}">
                                <option value="${customer.customerId}" ${inbound.customerId == customer.customerId ? 'selected' : ''}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="warehouseId" class="form-select" required>
                            ...
                            <c:forEach var="warehouse" items="${warehouseList}">
                                <option value="${warehouse.warehouseId}" ${inbound.warehouseId == warehouse.warehouseId ? 'selected' : ''}>
...
<script>
    let detailIndex = ${empty inbound.detailList ? 0 : inbound.detailList.size()};
